          ...
          <div class="card">
            <div class="card-body">
                ...
                <div>
                    ...
                    <p class="card-subtitle mb-4">잔여 휴가 <span class="text-primary">20일</span> (연차 18일)</p>
                    <p>
                ...
                <div class="mt-8">
                    ...
                    <p id="selectedDate" style="display: inline; margin-right: 10px;"></p>
                        <select class="form-select w-auto" style="display: inline; width: auto; margin-left: 12px;">
                        ...
                        <div class="timeselected">
	                        <select class="form-select w-auto" style="display: inline; width: auto; margin-left: 15px;">
                ...
                <div class="mt-8">
                  <p class="card-title fw-semibold mb-4">사유</p>
                    ...
                    <div class="d-flex align-items-center gap-6 flex-wrap mb-8 mt-8 ">
                      <button class="btn btn-primary ms-auto">신청하기</button>
                    </div>

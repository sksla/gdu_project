                  ...
                  <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      <li class="breadcrumb-item">
                        <a class="text-muted text-decoration-none" href="${ contextPath }/member/mainpage"
                          >Home</a
                        >
                      </li>
                  ...
                  <div class="" style="height: 38.33px; width: 50%;">
                    <form class="d-flex flex-row">
                      ...
                      <div class="input-group">
                          <input type="text" class="form-control" name="keyword" placeholder="검색어를 입력하세요." aria-label="Recipient's username" aria-describedby="basic-addon2">
                ...
                <table class="table border text-nowrap mb-0 align-middle app_doc_table overflow-hidden">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <p class="mb-0 fw-normal fs-4">자료게시판제목1</p>
                      </td>
                      <td>
                        <p class="mb-0 fw-normal fs-4">2024-05-07</p>
                      </td>
                      <td>
                        <p class="mb-0 fw-normal fs-4">김춘식</p>
                      </td>
                      <td>
                        <p class="mb-0 fw-normal fs-4">258</p>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td><p class="mb-0 fw-normal fs-4">1</p></td>
                      <td><p class="mb-0 fw-normal fs-4">자료게시판제목1</p></td>
                      <td><p class="mb-0 fw-normal fs-4">2024-05-07</p></td>
                      <td><p class="mb-0 fw-normal fs-4">김춘식</p></td>
                      <td><p class="mb-0 fw-normal fs-4">258</p></td>
                      <td>
                        <p class="mb-0 fw-normal fs-4">
                          <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
                            <g fill="none">

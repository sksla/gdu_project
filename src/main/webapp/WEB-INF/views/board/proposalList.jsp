          ...
          <div class="card ">
            <div class="card-body">
              ...
              <div class="table-responsive mb-4">
                <table class="table border text-nowrap mb-0 align-middle app_doc_table overflow-hidden table-hover">

              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div action="#" class="dropzone">
                   ...
                   -->
                  <div class="p-4" id="fileList">
                  	<c:choose>
	                  	<c:when test="${ not empty docInfo.attachList }">
	                  	<ul>
                    		<c:forEach var="att" items="${ docInfo.attachList }">
                    		<li>
            ...
            <div class="card-body">
              <div class="mb-3">
                <label for="example-text-input" class="col-md-12 h1 col-form-label fs-4">
                  협조<span class="ps-3 fs-2">2024-05-08</span>
                </label>
                <table class="app_comment" style="width: 100%; border: 1px solid lightgrey;">
                  <tr>
                    ...
                    <td class="px-3" style="vertical-align: middle;">승인합니다.</td>
                  </tr>
                </table>
              </div>
              <div class="mb-3">
                <label for="example-text-input" class="col-md-12 h1 col-form-label fs-4">
                  결재<span class="ps-3 fs-2">2024-05-08</span>
                </label>
                <table class="app_comment" style="width: 100%; border: 1px solid lightgrey;">
                  <tr>
                    <th height="100px">
              ...
              <div class="mb-3">
                <label for="example-text-input" class="col-md-12 h1 col-form-label fs-4">
                  수신<span class="ps-3 fs-2">2024-05-08</span>
                </label>
                <table class="app_comment" style="width: 100%; border: 1px solid lightgrey;">
                  <tr>
                    <th height="100px">
                    ...
                    <td class="px-3" style="vertical-align: middle;">반려합니다.</td>
                  </tr>
                </table>
              </div>
            </div>

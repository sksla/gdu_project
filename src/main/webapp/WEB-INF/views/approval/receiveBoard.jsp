...
<body>
            ...
            <div class="mb-4">
              <div class="d-flex justify-content-between">
                <div class="" style="height: 38.33px; width: 50%;">
                  <form action="${contextPath}/approval/receiveBoard.do" method="get" class="d-flex flex-row search_form">
                    ...
                    <div class="form-group" style="width: 150px;">
                      <select class="form-select search_type" name="searchType" id="">
                ...
                <form action="${contextPath}/approval/receiveBoard.do" class="d-flex flex-row date_form" style="height: 38.33px;">
                ...
                <tbody>
                	<c:choose>
                		...
                		<c:otherwise>
		                    ...
		                    <td>
		                      <p class="mb-0 fw-normal fs-4">${ appDoc.drafter.memName }</p>
		                    </td>
		                    <td>
    ...
    <script>
    	// 검색 옵션 관련 전역변수
   		...
   		let $searchType = "${optionMap.searchType == '' ? 'noOption' : optionMap.searchType}";
      ...
      let $endDate = "${optionMap.endDate}"
    	...
    	$(document).ready(function(){
    		console.log($(".selectGroupping").val());
    		...
    		$(".selectGroupping").on("change", function(){
       		...
       		location.href="${contextPath}/approval/receiveBoard.do?search=" + $search 

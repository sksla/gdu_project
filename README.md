...
<details>
 ...
 <ul>
  <li>실시간 채팅(첨부파일 전송)</li>
  <li>채팅방 생성 및 초대</li>
 </ul>
</details>
<details>
 <summary>4. 일정 & 알림 ✨</summary>
 <ul>
  <li>일정(개인캘린더, 공유캘린더) ✔</li>
  <li>학사일정 ✔</li>
  <li>투두리스트 ✔</li>
  <li>알림(공유캘린더 등록시) ✔</li>
 </ul> 
...
<details>
 <summary>9. 메인 페이지 ✨</summary>
 <ul>
  <li>출퇴근 처리</li>
  <li>개인 맞춤형 정보조회(오늘의 시설예약 ✔, 결재처리 현황, 오늘의 할일 ✔ </span>)</li>
  <li>공지사항 및 학사일정 조회 ✔</li>
 </ul>
</details>
